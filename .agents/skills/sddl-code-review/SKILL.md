...
- the orchestrator loads `sdd-lite/orchestrator/modules/review-runtime.md`, freezes the target, triages it, and launches each lens as a fresh read-only `sddl-reviewer` worker using its Review Worker Envelope
