...
- First: use the preloaded skill named in `stage`, or Read `sdd-lite/skills/<stage>/SKILL.md` in full if it is not preloaded. Follow only that skill and return exactly the fields in its "Expected Output" section.
