...
- First: use the preloaded `sddl-executor` skill, or Read `sdd-lite/skills/sddl-executor/SKILL.md` in full if it is not preloaded. Follow it for the approved stage in the handoff and return exactly the fields in its "Expected Output" section.
