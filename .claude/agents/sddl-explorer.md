...
- First: use the preloaded `sddl-deep-explorer` skill, or Read `sdd-lite/skills/sddl-deep-explorer/SKILL.md` in full if it is not preloaded. Follow it and return exactly the fields in its "Expected Output" section.
