...
- First: use the preloaded `sddl-proposal` skill, or Read `sdd-lite/skills/sddl-proposal/SKILL.md` in full if it is not preloaded. Follow it and return exactly the fields in its "Expected Output" section.
