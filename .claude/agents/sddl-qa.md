...
- First: use the preloaded `sddl-qa-review` skill, or Read `sdd-lite/skills/sddl-qa-review/SKILL.md` in full if it is not preloaded. Follow it for the mode in the handoff and return exactly the fields in its "Expected Output" section.
