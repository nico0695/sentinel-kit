...
- judge prompts come from `references/judge-prompt.md`; findings follow `sdd-lite/skills/_shared/sddl-review-ledger-contract.md`
...
- `sdd-lite/skills/_shared/sddl-review-ledger-contract.md` (row contract and convergence buckets)
