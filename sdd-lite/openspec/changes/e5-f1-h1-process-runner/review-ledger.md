...
- round: 0
- counts: confirmed=1 suspect=0 escalated=0 info=6
- open_severe_findings: 1
- verdict: fail
- next_action_digest: One confirmed CRITICAL (R4-001, deterministic, verified by direct code reading — no refuter needed). Raise review_gate for a fix stage.
...
|---|---|---|---|---|---|---|
| 1 | e5-f1-h1-process-runner @ 046ca31 | 4r | full-4r | 0 | fail | 2026-08-23T01:55:00Z |
...
(none yet — awaiting `review_gate` decision)
